...
class FlightInfo extends RouterInfo{
    ...
    public ars.RouterInfo getRouterInfo(){
        return router;
    }
    ...
    public String toString() {
        return " Flight ID " + flightID + ", From " + router.from + ", To " + router.to + ", ars.Date " + Date.getDay(day) + " Time " + Date.getHour(timeIn) + " -> " + Date.getHour(timeOut) + ", Available " + (5-seat) + " seat.";
    }
