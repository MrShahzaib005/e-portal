...
import public Main.scanner;
import public Main.mainMode;
import public Main.router;
import public Main.flight;

public class Flight extends Date {
    public static int flight_seat = 5;
    public static int flight_per_router = 4;
    public static int flight_size = ars.Router.router_size * flight_per_router * 7;
    public static ars.FlightInfo[] flight_info = new ars.FlightInfo[flight_size];
    ...
    private void generate() {
        ...
        flight_info[1] = new ars.FlightInfo(router_info[0], "TG2170", 0, "11:30", "12.15");
        ...
        for(int day=1; day<7; day++){
            for(int rout = 0; rout < 12; rout ++ ){
                for (int i=0; i<4; i++){
                    flight_info[index++] = new FlightInfo(router_info[rout], "TG"+ilovekmitl++, day, getHour(flight_info[index%48].getTimeIn()), getHour(flight_info[index%48].getTimeOut()));
                }
